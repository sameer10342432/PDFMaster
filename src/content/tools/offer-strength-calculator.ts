...
### Do:
✅ Get strongest pre-approval possible
✅ Respond quickly to all communications
✅ Be flexible on non-critical terms
✅ Show financial strength
✅ Make clean, professional offer
✅ Write personal letter (where allowed)
✅ Trust your agent's advice

### Don't:
❌ Make emotional decisions
❌ Waive protections you truly need
❌ Exceed your budget
❌ Play games or lowball
❌ Be inflexible on everything
❌ Ignore seller motivations
❌ Submit incomplete offers

The strongest offer isn't always the highest price—it's the one that best meets the seller's needs while protecting your interests. Use this calculator to find that sweet spot and win your dream home!
    `,
  },
  calculator: {
    fields: [
    ...
    calculate: (values) => {
      ...
      let winProbability = "";
      if (totalScore >= 90) {
        rating = "🏆 ELITE OFFER - Extremely competitive, very likely to win";
        winProbability = "90-95% in competitive situations";
      } else if (totalScore >= 80) {
        rating = "⭐ STRONG OFFER - Highly competitive, good chance to win";
        winProbability = "70-85% in competitive situations";
      } else if (totalScore >= 70) {
        rating = "✓ MODERATE OFFER - Competitive, decent chance";
        winProbability = "50-65% in competitive situations";
      } else if (totalScore >= 60) {
        rating = "⚠️ WEAK OFFER - Below average, needs improvement";
        winProbability = "30-45% in competitive situations";
      } else {
        rating = "❌ VERY WEAK OFFER - Unlikely to win, major changes needed";
      ...
      if (priceScore < 35) suggestions += "• Increase offer price to at least asking price or above\n";
      if (contingencyScore < 20) suggestions += "• Reduce contingencies if comfortable (consider inspection-only or as-is)\n";
      if (earnestScore < 8) suggestions += "• Increase earnest money to 3-5% to show stronger commitment\n";
      if (timelineScore < 12) suggestions += "• Offer flexible closing timeline or seller's preferred dates\n";
      if (financingScore < 9 && financingType !== "cash") suggestions += "• Get strongest pre-approval possible, consider conventional financing\n";
      if (rentBack === "no") suggestions += "• Consider offering rent-back option to make seller's transition easier\n";
      
      if (totalScore >= 90) {
        suggestions = "✅ Excellent offer! Your terms are very competitive. Only minor refinements possible:\n\n• You're in great position to win\n• Stay firm in negotiations\n• Be prepared to move quickly\n• Have backup plan if you don't win";
      }
