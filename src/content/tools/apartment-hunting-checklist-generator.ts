    ...
    fields: [
      {
        ...
        type: "select",
        options: [{ value: "Urban/Walkable", label: "Urban/Walkable" }, { value: "Suburban/Quiet", label: "Suburban/Quiet" }, { value: "Commuter-Focused", label: "Commuter-Focused" }, { value: "Nightlife/Social", label: "Nightlife/Social" }],
      ...
      },
      {
        ...
        type: "select",
        options: [{ value: "Budget-Friendly", label: "Budget-Friendly" }, { value: "Mid-Range", label: "Mid-Range" }, { value: "Luxury", label: "Luxury" }],
      ...
      },
      {
        ...
        type: "select",
        options: [{ value: "Not Important", label: "Not Important" }, { value: "Somewhat Important", label: "Somewhat Important" }, { value: "Very Important", label: "Very Important" }],
